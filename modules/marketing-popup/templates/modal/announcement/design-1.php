<?php
/**
* Template for Modal Popup Announcement Design 1
*
* This template can be overridden by copying it to yourtheme/inboundwp-lite/marketing-popup/modal/announcement/design-1.php
*
...
<div class="ibwp-mfp-popup-body ibwp-mp-popup ibwp-mp-modal-popup ibwp-mp-popup-<?php echo $popup_id; ?> ibwp-mp-popup-js ibwp-mp-popup-page-load ibwp-mp-popup-<?php echo $popup_goal; ?> ibwp-mp-<?php echo $template; ?> ibwp-mp-ann-<?php echo $template; ?> mfp-hide" id="ibwp-mp-popup-<?php echo $popup_id; ?>" data-conf="<?php echo $popup_conf; ?>">
