<?php
/**
* Template for Modal Popup Email Lists Design 2
*
* This template can be overridden by copying it to yourtheme/inboundwp-lite/marketing-popup/modal/email-lists/design-2.php
*
...
<div class="ibwp-mfp-popup-body ibwp-mp-popup ibwp-mp-modal-popup ibwp-mp-popup-<?php echo $popup_id; ?> ibwp-mp-popup-js ibwp-mp-popup-page-load ibwp-mp-popup-<?php echo $popup_goal; ?> ibwp-mp-<?php echo $template; ?> ibwp-mp-ce-<?php echo $template; ?> ibwp-right mfp-hide" id="ibwp-mp-popup-<?php echo $popup_id; ?>" data-conf="<?php echo $popup_conf; ?>">
