<?php
/**
* Template for Modal Popup Phone Calls Design 1
*
* This template can be overridden by copying it to yourtheme/inboundwp-lite/marketing-popup/modal/phone-calls/design-1.php
*
...
<div class="ibwp-mfp-popup-body ibwp-mp-popup ibwp-mp-modal-popup ibwp-mp-popup-<?php echo $popup_id; ?> ibwp-mp-popup-js ibwp-mp-popup-page-load ibwp-mp-popup-<?php echo $popup_goal; ?> ibwp-mp-<?php echo $template; ?> ibwp-mp-pc-<?php echo $template; ?> mfp-hide" id="ibwp-mp-popup-<?php echo $popup_id; ?>" data-conf="<?php echo $popup_conf; ?>">
		...
		<div class="ibwp-display-flex">
			...
			<div class="<?php echo ( $style['bg_img'] ) ? '' : 'ibwp-no-image'; ?> ibwp-mp-popup-con-bg" style="<?php echo $style['bg_clr']; ?>">
				<div class="ibwp-mp-popup-inr">
					...
					if( $btn_txt && $phone_num ) { ?>
						<div class="ibwp-mp-cta-wrap">
							<a class="ibwp-mp-btn ibwp-mp-report-btn ibwp-mp-btn-1" href="tel:+<?php echo $phone_num; ?>"><?php echo $btn_txt; ?></a>
						</div>
					<?php } ?>
