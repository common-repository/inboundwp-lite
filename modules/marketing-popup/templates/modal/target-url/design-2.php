<?php
/**
* Template for Modal Popup Target URL Design 2
*
* This template can be overridden by copying it to yourtheme/inboundwp-lite/marketing-popup/modal/target-url/design-2.php
*
...
<div class="ibwp-mfp-popup-body ibwp-mp-popup ibwp-mp-modal-popup ibwp-mp-popup-<?php echo $popup_id; ?> ibwp-mp-popup-js ibwp-mp-popup-page-load ibwp-mp-popup-<?php echo $popup_goal; ?> ibwp-mp-<?php echo $template; ?> ibwp-mp-tu-<?php echo $template; ?> ibwp-right mfp-hide" id="ibwp-mp-popup-<?php echo $popup_id; ?>" data-conf="<?php echo $popup_conf; ?>">
