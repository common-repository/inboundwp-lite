...
<div id="ibwp_spw_integration_sett" class="ibwp-vtab-cnt ibwp-spw-integration-sett ibwp-clearfix ibwp-pro-feature">

	<div class="ibwp-tab-info-wrap">
		<div class="ibwp-tab-title"><?php esc_html_e('Integration Settings', 'inboundwp-lite'); ?></div>
		<span class="ibwp-tab-desc"><?php echo esc_html__('Choose Wheel mail integration settings. ', 'inboundwp-lite') . ibwpl_upgrade_pro_link(); ?></span>
	</div>
	...
	<table class="form-table ibwp-tbl">
		<tbody>
			<tr>
				<th>
					<label for="ibwp-spw-mc-enable"><?php _e('Enable','inboundwp-lite'); ?></label>
				</th>
				<td>
					<input type="checkbox" name="" value="" id="ibwp-spw-mc-enable" disabled /><br/>
...
</div><!-- end .ibwp-spw-integration-sett -->